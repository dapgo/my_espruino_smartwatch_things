/* Test  bangle.js input interface */
 ...
 var v_str_version='v0.07'; //testing purpose
...
function DrawBangleButtons(){    
    ...
    //g.setFontAlign(-1,-1,1); // bad align? ¿bug?
    
    g.setFontAlign(-1,1,1); //y=1 rotated and besides to right border
...
function DrawRowSelArrow(v_drawRow, v_clearRow){   
  ...
  //PEND, simplify Clear all column box and draw over
